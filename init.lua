...
-- Indentation: render a tab as 2 columns, and indent by 2.
--  `guess-indent.nvim` still flips `expandtab` per-buffer based on the file's
--  existing style, but the *width* comes from these values.
vim.o.tabstop = 2
vim.o.shiftwidth = 2
vim.o.softtabstop = 2
